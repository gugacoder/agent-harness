...
### Mapa de portas (${PREFIX}XX)
    ...
    Sources (apps)
      ...
      ${PREFIX}01  LANDING_PORT
      ${PREFIX}02  HUB_PORT
      ${PREFIX}03  ROTA_PORT
      ${PREFIX}04  PORTAL_PORT
...
- Sources (landing, hub, rota, portal, backbone) rodam no host
...
## Sources
    ...
    landing  :${PREFIX}01  — landing page institucional
    hub      :${PREFIX}02  — app operacional da empresa
    rota     :${PREFIX}03  — app do motoboy
    portal   :${PREFIX}04  — app do cliente (pedidos)
