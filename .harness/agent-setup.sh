#!/usr/bin/env bash
# =============================================================================
# Agent Setup - PRP-003-central-wave2 (Wave 2 - Harness B Implementation)
...
echo "=== Agent Setup: PRP-003-central-wave2 ==="
echo ""
...
echo "  Session:   PRP-003-central-wave2--cc"
echo "  Runs dir:  .harness/runs/PRP-003-central-wave2--cc/ (ROOT)"
echo ""
echo "=== Setup completo ==="
