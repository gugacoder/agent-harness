#!/usr/bin/env bash
# =============================================================================
# Agent Setup - PRP-001-foundation-schemas-pricing (Wave 2 - Harness B Implementation)
...
echo "=== Agent Setup: PRP-001-foundation-schemas-pricing ==="
echo ""
...
echo "  Session:   PRP-001-foundation-schemas-pricing--cc"
echo "  Runs dir:  .harness/runs/PRP-001-foundation-schemas-pricing--cc/ (ROOT)"
echo ""
echo "=== Setup completo ==="
